...
// ANSWER: both depend on the length of the array.
...
// CODE HERE 
function plusFiveNumNoCache(num) {
  let answer = num + 5
  return answer
  }
...
// ANSWER: the one that has cache.

// Now fill this out and run your file

const myAdd = new newCacheAndMethod // CREATE A NEW INSTANCE OF YOUR CLASS

console.time("not memoized function time");
console.log(plusFiveNumNoCache(4))
console.log(plusFiveNumNoCache(4))
console.log(plusFiveNumNoCache(4))
console.log(plusFiveNumNoCache(4))
...
console.log(myAdd.plusFiveNum(4))
console.log(myAdd.plusFiveNum(4))
console.log(myAdd.plusFiveNum(4))
console.log(myAdd.plusFiveNum(4))
